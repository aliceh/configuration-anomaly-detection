...
func (i *Investigation) Run(r *investigation.Resources) (investigation.InvestigationResult, error) {
	...
	if network != "OVNKubernetes" && network == "OpenshiftSDN" {
		...
		notes.AppendWarning("non-OVN network detected, please investigate. SOP: https://github.com/openshift/ops-sop/blob/master/v4/alerts/PruningCronjobErrorSRE.md", err)
	}
